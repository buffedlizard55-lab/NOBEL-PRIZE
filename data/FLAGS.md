...
API v2 known/org name is “Fred Ramsdell”. API v1 name is “Frederick J. Ramsdell”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “John J. Hopfield”. API v1 name is “John Hopfield”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Han Kang”. API v1 name is “Kang Han”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “James A. Robinson”. API v1 name is “James Robinson”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “K. Barry Sharpless”. API v1 name is “Barry Sharpless”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Joshua D. Angrist”. API v1 name is “Joshua Angrist”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Guido W. Imbens”. API v1 name is “Guido Imbens”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “David W.C. MacMillan”. API v1 name is “David MacMillan”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Harvey J. Alter”. API v1 name is “Harvey Alter”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Charles M. Rice”. API v1 name is “Charles Rice”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Paul R. Milgrom”. API v1 name is “Paul Milgrom”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Robert B. Wilson”. API v1 name is “Robert Wilson”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “William G. Kaelin Jr”. API v1 name is “William Kaelin”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Sir Peter J. Ratcliffe”. API v1 name is “Peter Ratcliffe”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Gregg L. Semenza”. API v1 name is “Gregg Semenza”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “John B. Goodenough”. API v1 name is “John Goodenough”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Tu Youyou”. API v1 name is “Youyou Tu”. The v2 name is displayed. Neither was rewritten.
...
Recorded death date 2011-09-30 is earlier than recorded award date 2011-10-03. This is a date comparison, not a judgment that the award violated the statutes. Review the facts page and statutes.
...
API v2 known/org name is “Liu Xiaobo”. API v1 name is “Xiaobo Liu”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Barack H. Obama”. API v1 name is “Barack Obama”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Gao Xingjian”. API v1 name is “Xingjian Gao”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “The 14th Dalai Lama”. API v1 name is “Lhamo Thondup”. The v2 name is displayed. Neither was rewritten.
...
API v2 known/org name is “Mother Teresa”. API v1 name is “Anjezë Gonxhe Bojaxhiu”. The v2 name is displayed. Neither was rewritten.
...
Official API prizeStatus is “declined”. This archive does not translate that word.
...
Two official pages describe this decline differently. Facts page: Le Duc Tho “said that he was not in a position to accept the Nobel Peace Prize, citing the situation in Vietnam as his reason.” His facts page says “Le Duc Tho declined the Nobel Peace Prize” and, in the biographical note, that he “refused to accept it, on the grounds that his opposite number had violated the truce.” Both wordings are retained. This archive does not pick one.
...
Nobel Prize facts page: “Jean-Paul Sartre, awarded the 1964 Nobel Prize in Literature, declined the prize because he had consistently declined all official honours.”
...
Recorded death date 1961-09-18 is earlier than recorded award date 1961-10-23. This is a date comparison, not a judgment that the award violated the statutes. Review the facts page and statutes.
...
Nobel Prize facts page: before 1974 the prize was awarded posthumously twice, including to Dag Hammarskjöld, Nobel Peace Prize 1961.
...
Official API prizeStatus is “restricted”. This archive does not translate that word.
...
Nobel Prize facts page: Boris Pasternak initially accepted the 1958 literature prize but was later coerced by the authorities of the Soviet Union to decline it. The API record retrieved for this laureate used prizeStatus “restricted”, not “declined”. Both are shown. This archive does not collapse them into one label.
...
A sourced official narrative mentions decline, but API prizeStatus is “restricted”. Both are kept.
...
API v2 known/org name is “Lord Boyd Orr”. API v1 name is “John Boyd Orr”. The v2 name is displayed. Neither was rewritten.
...
Nobel Prize facts page: Adolf Hitler forbade three German laureates, including Gerhard Domagk, from accepting the prize. They could later receive the diploma and medal, but not the prize amount. The API prize status, when present, is shown separately and is not rewritten to match this sentence.
...
Nobel Prize facts page: Adolf Hitler forbade three German laureates, including Adolf Butenandt, from accepting the prize. They could later receive the diploma and medal, but not the prize amount. The API prize status, when present, is shown separately and is not rewritten to match this sentence.
...
Nobel Prize facts page: Adolf Hitler forbade three German laureates, including Richard Kuhn, from accepting the prize. They could later receive the diploma and medal, but not the prize amount. The API prize status, when present, is shown separately and is not rewritten to match this sentence.
...
API v2 known/org name is “Robert Cecil, Viscount Cecil of Chelwood”. API v1 name is “Robert Cecil”. The v2 name is displayed. Neither was rewritten.
...
Recorded death date 1931-04-08 is earlier than recorded award date 1931-11-08. This is a date comparison, not a judgment that the award violated the statutes. Review the facts page and statutes.
...
Nobel Prize facts page: before 1974 the prize was awarded posthumously twice, including to Erik Axel Karlfeldt, Nobel Prize in Literature 1931.
...
K. Barry Sharpless is attached to 2 prize records in the downloaded data: chemistry-2022, chemistry-2001.
...
Office of the United Nations High Commissioner for Refugees is attached to 2 prize records in the downloaded data: peace-1981, peace-1954.
...
Frederick Sanger is attached to 2 prize records in the downloaded data: chemistry-1980, chemistry-1958.
...
John Bardeen is attached to 2 prize records in the downloaded data: physics-1972, physics-1956.
...
International Committee of the Red Cross is attached to 3 prize records in the downloaded data: peace-1963, peace-1944, peace-1917.
...
Linus Pauling is attached to 2 prize records in the downloaded data: peace-1962, chemistry-1954.
...
Marie Curie is attached to 2 prize records in the downloaded data: chemistry-1911, physics-1903.
...
On 2026-09-24 the nomination archive homepage table totalled 23141 nominations, while the advanced search page said 23983. Both numbers are official and they disagree. This archive does not average or choose one.
